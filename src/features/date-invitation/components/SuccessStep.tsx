...
export function SuccessStep({ activity, city, date, time, onStartOver }: SuccessStepProps) {
  return (
    <section className="screen success-screen">
      <div className="success-icon">♥</div>
      <h1>Класс. Теперь у нас есть план!</h1>
      <p className="subtitle">С меня хорошая компания, с тебя — улыбка и хорошее настроение</p>
